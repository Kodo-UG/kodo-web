...
const Features = () => {
  return (
    <section className="steps-area p-relative " style={{ backgroundColor: '#032e3f', paddingBottom: '100px', paddingTop: '100px' }}>
      <div className="animations-10 ">
        <img src="https://res.cloudinary.com/itgenius/image/upload/v1688241999/an-img-10_g61hnh.png" alt="an-img-01" />
      </div>
            ...
            <ul className="pr-20">
                ...
                <div className="step-box wow fadeInUp animated" data-animation="fadeInUp" data-delay=".4s">
                  <div className="dnumber">
                    <div className="date-box">
                      <img src="https://res.cloudinary.com/itgenius/image/upload/v1688241848/fea-icon01_wzszas.png" alt="icon" />
                    </div>
                  </div>
                  <div className="text">
              ...
              <li>
                <div className="step-box wow fadeInUp animated" data-animation="fadeInUp" data-delay=".4s">
                  <div className="dnumber">
                    <div className="date-box">
                      <img src="https://res.cloudinary.com/itgenius/image/upload/v1688241848/fea-icon02_eyvyv9.png" alt="icon" />
                    </div>
                  </div>
                  <div className="text">
              ...
              <li>
                <div className="step-box wow fadeInUp animated" data-animation="fadeInUp" data-delay=".4s">
                  <div className="dnumber">
                    <div className="date-box">
                      <img src="https://res.cloudinary.com/itgenius/image/upload/v1688241848/fea-icon03_loll6n.png" alt="icon" />
                    </div>
                  </div>
                  <div className="text">
