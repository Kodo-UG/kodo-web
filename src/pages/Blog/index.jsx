                ...
                <div class="row align-items-center">
                    <div class="col-lg-4 col-md-6 ">
                        <div class="courses-item mb-30 hover-zoomin">
                            <div class="thumb fix">
                                <a href="#"><img src="https://www.kodoscholarships.com/img/blog/muslim.jpg" alt="contact-bg-an-01" /></a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 ">
                        <div class="courses-item mb-30 hover-zoomin">
                            <div class="thumb fix">
                                <a href="#"><img src="https://www.kodoscholarships.com/img/blog/gamers.jpg" alt="contact-bg-an-01" /></a>
                            </div>
                            <div class="courses-content">
                    ...
                    <div class="col-lg-4 col-md-6 ">
                        <div class="courses-item mb-30 hover-zoomin">
                            <div class="thumb fix">
                                <a href="#"><img src="https://www.kodoscholarships.com/img/blog/woman.jpg" alt="contact-bg-an-01" /></a>
                            </div>
                            <div class="courses-content">
                    ...
                    <div class="col-lg-4 col-md-6 ">
                        <div class="courses-item mb-30 hover-zoomin">
                            <div class="thumb fix">
                                <a href="#"><img src="https://www.kodoscholarships.com/img/blog/grad.jpg" alt="contact-bg-an-01" /></a>
                            </div>
                            <div class="courses-content">
                    ...
                    <div class="col-lg-4 col-md-6 ">
                        <div class="courses-item mb-30 hover-zoomin">
                            <div class="thumb fix">
                                <a href="#"><img src="https://www.kodoscholarships.com/img/blog/whiteguy.jpg" alt="contact-bg-an-01" /></a>
                            </div>
                            <div class="courses-content">
                                <div class="cat"><i class="fal fa-graduation-cap"></i> Guide</div>
                                ...
                                <p>Tired of the broke college student stereotype? Well, these days, in the glorious age of the internet… your options for making money are practically endless. Well, maybe not endless.
                                    But, there are at least 39 potential online jobs for college students that can have you making GOOD moneywithout needing to add too much pressure to your already busy college schedule!
                                    And, in this guide, were going to look at what each of those online jobs entails, how much money you can make, where to look for work online, and where you can find more information to get started ASAP.
                                </p>
                                <a href="#" class="readmore">Read More <i class="fal fa-long-arrow-right"></i></a>
                            </div>
                            <div class="icon">
