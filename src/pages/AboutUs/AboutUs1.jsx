			...
			<div className="container">
				<div className="row justify-content-center align-items-center">
					<div className="col-lg-6 col-md-12 col-sm-12">
						...
						>
							<img
								src="https://res.cloudinary.com/dmhsf5hqd/image/upload/v1688928035/about_img_05-1_sz6j5v.png"
								alt="img"
							/>
					...
					<div className="col-lg-6 col-md-12 col-sm-12">
						...
						>
							<div className="about-title second-title pb-25">
								<h5>
									<i className="fal fa-graduation-cap"></i> About Kodo
									Scholarships
								</h5>
								<h2>About Kodo</h2>
							</div>
							<p class="txt-clr">
								...
								comprehensive list of scholarships, grants and Jobs that
								are available to international students from around the
								world. It is our aim to help you find opportunities for
								higher education and become agents of development in
								your own countries and the rest of the world.{" "}
							</p>
							<p>
												...
												<div class="abcontent">
													...
													<div class="text">
														...
														<p>
															...
															individuals and organization when
															it comes to the demand htmlFor
															Scholarships and Job offers in the
															whole of Africa and the rest of
															world.
														</p>
													</div>
												</div>
