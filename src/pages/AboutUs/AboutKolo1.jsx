          ...
          <div className="col-lg-6 col-md-12">
            ...
            >
              ...
              <div className="text">
                <h2>Kodo Jobs</h2>
                <p>
                  Looking for a remote job as a developer, customer service rep,
                  recruiter, designer or sales professional? Browse openings in
                  those categories and more . We hand curate a list to showcase
                  the best remote job opportunities in the most recruited job
                  categories. Find a remote job here to launch your work
                  anywhere career.
                </p>
              </div>
            </div>
